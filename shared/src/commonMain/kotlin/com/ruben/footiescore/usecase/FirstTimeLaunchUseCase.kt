 ...
 **/
class GetFirstTimeLaunchUseCase(private val repository: FootballRepository): BaseStorageUseCase<Unit, Boolean>() {
...
class StoreFirstTimeLaunchUseCase(private val repository: FootballRepository): BaseNoResponseUseCase<StoreFirstTimeLaunchUseCase.RequestValue>() {
